  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.allProductsSection}>
        ...
        <Text style={styles.allProductsText}>TOUS MES PRODUITS ({totalProducts})</Text>
      </View>
              ...
              <View key={stock._id} style={styles.productRow}>
                <View style={styles.productInfo}>
                  <View style={styles.productDetails}>
                    <Text style={styles.productName}>{stock.product.name}</Text>
                    <Text style={styles.productPrice}>{stock.price} € / 100g</Text>
                  </View>
                ...
                <TouchableOpacity onPress={() => { /* View details */ }} style={styles.viewButton}>
