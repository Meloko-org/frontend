      ...
      <ScrollView className="w-full flex-1">
        ...
        <Modal
          ...
          <SafeAreaView className="flex-1 bg-lightbg dark:bg-darkbg p-3 items-center">
            ...
            <TouchableOpacity onPress={() => setLogoModalVisible(!logoModalVisible)}>
              <FontAwesome name="arrow-left" size={25} color="#98B66E" className="absolute" style={{right: 20}} /> 
            </TouchableOpacity>

            <View className="flex-1 justify-center">
              <TextHeading3 centered extraClasses="mb-5">Modifier le logo</TextHeading3>
              <Text 
                value={logoFile}
