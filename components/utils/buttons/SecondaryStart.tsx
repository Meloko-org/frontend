...
export default function ButtonSecondaryStart(props: ButtonSecondaryStartProps): JSX.Element {
	...
	return (
		...
		{ props.isLoading ? (
			...
			<>
				<Text className="text-darkbg text-center m-2 font-bold text-[24px] dark:text-lightbg">{props.label}</Text>
				<FontAwesome name={props.iconName} size={25} color={colorScheme === 'dark' ? '#FCFFF0' : '#262E20'} className="absolute" style={{left: 20}} />
			</>
