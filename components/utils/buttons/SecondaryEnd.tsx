...
export default function ButtonSecondaryEnd(props: ButtonSecondaryEndProps): JSX.Element {
	...
	return (
		...
		{ props.isLoading ? (
			...
			<>
				...
				<FontAwesome name={props.iconName} size={25} color={colorScheme === 'dark' ? '#FCFFF0' : '#262E20'} className="absolute" style={{right: 20}} />
			</>
