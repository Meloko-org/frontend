...
export default function Market(props: CardMarketProps): JSX.Element {
  ...
  return (
    <TouchableOpacity
      onPress={(event) => props.onPressFn && props.onPressFn(props.marketData)}
    >
      <View
        className={`${props.extraClasses} flex rounded-lg p-2 shadow-lg bg-white dark:bg-tertiary w-full`}
      >
